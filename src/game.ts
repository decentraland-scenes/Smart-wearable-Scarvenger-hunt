  ...
  update(dt: number) {
    ...
    if (countDown > 0) {
      ...
      if (dist < 20) {
        ...
        text.value =
          'Go to Dragon Rush (-42,54) and find the dragon in\n less than ' +
          Math.ceil(countDown) +
          ' seconds!'
      }
...
async function finishGame() {
  ...
  //   const module = await dcl.loadModule('@decentraland/PortableExperiences')
  //   await dcl.callRpc(module.rpcHandle, 'exit', [])
}
